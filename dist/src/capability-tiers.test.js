...
import { defaultTierResolver, setCapabilityTierResolver, tierFor, } from './capability-tiers';
...
describe('tierFor', () => {
    ...
    it('reflects a host-registered resolver', () => {
        const policy = (cap) => cap.startsWith('secrets:') ? 'high' : cap.startsWith('tasks:') ? 'medium' : 'low';
