...
import { _resetStateChannelForTests, _stateChannelStatsForTests, closeRun, dropStateSnapshotsForWorkspaceSwitch, getSnapshot, openRun, setOpenCards, setToolState, snapshotWorkspace, subscribe, subscribeWorkspace, } from './state-channel';
...
describe('state-channel', () => {
    ...
    it('audit3: subscriber mutating openCards does NOT corrupt source-of-truth', () => {
        ...
        subscribe('r-mut', (vs) => {
            ...
            vs.snapshot.openCards.push(card('SHOULDNT-LAND'));
        });
