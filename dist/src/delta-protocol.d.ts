...
export type DeltaFullReason = 'no_request' | 'requested_full' | 'no_cursor' | 'cursor_malformed' | 'schema_changed' | 'view_changed' | 'changed' | 'revision_error' | 'not_capable' | 'bypass' | 'no_digest' | 'digest_expired' | 'max_age' | 'delta_too_large' | 'changesSince_error' | 'flag_off';
 ...
 */
export declare function computeRowDigestUncapped(rows: readonly unknown[], itemKey: (row: unknown) => string, rowRevision?: (row: unknown) => string | number): Record<string, string>;
/**
