...
export interface UnifiedToolContext {
     ...
     */
    principal?: (Pick<Principal, 'slug' | 'workspaceId' | 'capabilities'> & Partial<Pick<Principal, 'kind' | 'authMethod' | 'trust' | 'roles' | 'label'>>) | null;
    /**
 ...
 */
export declare function recordToolShapers(name: string, shape: PayloadShapers | undefined, returns?: string): void;
/** Every tool that declared payload shapers, with its `guidance.returns` prose. */
export declare function listDeclaredToolShapers(): ReadonlyArray<{
    name: string;
 ...
 */
export declare function resolveMcpName(name: string): ProjectedTool | undefined;
 ...
 */
export declare function projectedToolSourceFile(toolName: string): string | null;
/**
 ...
 */
export declare const PROJECTED_TOOL_REGISTRY_SOURCE: 'projected-tool-registry';
export declare function projectedToolRegistryRevision(tools?: readonly Pick<ProjectedTool, 'expose' | 'inputSchema' | 'discoveryInputSchema' | 'agentRoles' | 'profile' | 'modality' | 'guidance'>[]): string;
...
export interface ProjectedToolCallContract {
    ...
    aliases: Record<string, {
        target: string;
        provenance: 'authored-tool-guidance';
    }>;
}
export declare class ProjectedToolContractError extends Error {
    readonly name = "ProjectedToolContractError";
}
/** Resolve one exact, currently callable registry contract or fail render/CI loudly. */
export declare function projectedToolCallContract(name: string, context?: ProjectedToolAvailability): ProjectedToolCallContract;
/** Validate a prompt/example call against the same accepted schema used for discovery. */
export declare function assertProjectedToolCallContract(name: string, args: unknown, context?: ProjectedToolAvailability): ProjectedToolCallContract;
/** Render an exact example only after registry/schema/admission conformance succeeds. */
export declare function renderProjectedToolCall(name: string, args: unknown, context?: ProjectedToolAvailability): string;
/** Validate and render every structured rejected-arg remedy on one source tool. */
export declare function projectedToolCorrectiveCalls(name: string, context?: ProjectedToolAvailability): ValidatedProjectedToolCorrectiveCall[];
 ...
 */
export declare function assertProjectedToolGuidanceConformance(): ProjectedToolGuidanceConformance;
/**
