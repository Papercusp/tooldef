...
import { registerResource, lookupResource, getResourceCatalog, matchResource, _resetResourceCatalogForTests, } from './resource-registry';
const baseDef = (over = {}) => ({
...
describe('collision handling', () => {
    ...
    it('throws on a same-name collision with a different uri', () => {
        ...
        expect(() => registerResource(baseDef({ name: 'h', uri: 'papercusp://other/{slug}' }))).toThrow(/Resource name collision: "h"/);
    });
});
