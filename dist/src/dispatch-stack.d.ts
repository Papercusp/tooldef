...
export type DispatchStepName = 'default-deny' | 'role-allowlist' | 'capability-check' | 'capability-envelope' | 'role-requirement' | 'harness-check' | 'quota' | 'authorize' | 'preconditions' | 'entity-check' | 'timeout' | 'idle-watchdog' | 'replay-buffer' | 'ctx-bindings' | 'invoke';
/**
