 ...
 */
export type AgentRole = [RegisteredRole] extends [never] ? string : RegisteredRole | (string & {});
 ...
 */
export type PluginSpawn = (bin: string, args: readonly string[], opts?: PluginSpawnOptions) => Promise<PluginSpawnResult>;
export {};
