 ...
 */
export declare class UnauthorizedToolError extends Error {
    readonly name = "UnauthorizedToolError";
}
/**
 ...
 */
export declare class HarnessRequiredError extends Error {
    readonly name = "HarnessRequiredError";
}
/**
 ...
 */
export declare class WorkspaceTxNotDeclaredError extends Error {
    readonly name = "WorkspaceTxNotDeclaredError";
 ...
 */
export declare class WorkspaceTxUnavailableError extends Error {
    readonly name = "WorkspaceTxUnavailableError";
    constructor(toolName: string);
}
...
export declare class InvalidInputError extends Error {
    readonly metadata?: InvalidInputMetadata | undefined;
    readonly name = "InvalidInputError";
    constructor(message: string, metadata?: InvalidInputMetadata | undefined);
}
...
export declare const PASS_THROUGH: unique symbol;
/**
 ...
 */
export type ToolDispatchOverrideFn = (toolName: string, args: unknown, ctx: UnifiedToolContext) => Promise<{
    content: Array<{
        text?: string;
        [k: string]: unknown;
    }>;
...
export interface DispatchProjectedDeps {
    ...
    recordInvocation?(input: {
         ...
         */
        status: 'ok' | 'error' | 'quota-exceeded' | 'role-not-allowed' | 'timeout' | 'invalid-input' | 'refused' | 'replayed';
        /**
