...
const ENUM_FRAGMENT_CACHE = new Map();
const ENUM_FRAGMENT_IN_FLIGHT = new Map();
/**
...
async function loadFragment(kind, entry, useCache) {
    const now = Date.now();
    if (useCache) {
 ...
 */
async function loadFragments(kinds, opts = {}) {
    const out = new Map();
