...
exports.describeGroupFromMembers = describeGroupFromMembers;
exports.catalogueProjection = catalogueProjection;
exports.renderCapabilityMap = renderCapabilityMap;
exports.declaredGroupSlugs = declaredGroupSlugs;
const registry_1 = require("./registry");
const define_group_1 = require("./define-group");
 ...
 * zero authoring.
 */
function describeGroupFromMembers(members) {
...
function orderOf(group) {
    return (0, define_group_1.lookupGroup)(group)?.order ?? Number.MAX_SAFE_INTEGER;
}
/**
 ...
 */
function catalogueProjection(catalog = (0, registry_1.getCatalog)()) {
    ...
    for (const [group, members] of byGroup) {
        const declared = (0, define_group_1.lookupGroup)(group)?.summary;
 ...
 */
function renderCapabilityMap(entries = catalogueProjection(), opts = {}) {
...
function declaredGroupSlugs() {
    return (0, define_group_1.getGroupCatalog)()
