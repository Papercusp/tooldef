...
export function setServerVintageResolver(fn) {
    resolver = fn;
}
/** Clear the registered resolver — test seam + host teardown. */
export function resetServerVintageResolver() {
    resolver = null;
}
...
export function readServerVintage() {
    if (!resolver)
        return null;
    try {
        return resolver();
...
export function formatVintageAge(ms) {
