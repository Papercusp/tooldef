...
export type DispatchProjectedErrorCode = 'unknown_tool' | 'unauthorized' | 'role_not_allowed' | 'missing_capability' | 'missing_role' | 'harness_required' | 'quota_exceeded' | 'invalid_input' | 'handler_error' | 'authorization_denied' | 'ungated' | 'timeout';
/**
