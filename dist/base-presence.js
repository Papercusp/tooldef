...
class BasePresenceTracker {
     ...
     */
    negotiationFor(viewKey, wantSemantic = false) {
     ...
     */
    record(viewKey, mode, cursor, supported = true) {
        if (!this.enabled)
            return;
        if (!supported) {
